...
lake1 <- ggplot(PeterPaul.chem.nutrients, aes(x = sampledate, y = temperature_C)) + 
  geom_point() +
   facet_wrap(vars(lakename), nrow = 2)
#print(lake1)

lake2 <- ggplot(subset(PeterPaul.chem.nutrients, depth == 0), aes(x=daynum,y=temperature_C))+
