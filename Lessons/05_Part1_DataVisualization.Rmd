...
#parentheses have argument enclosed. Use '+' when adding layers in ggplot
#kind of like the pipe %>% operator 
...
#themes work for future ggplots 
#if you leave RProject, need to reset theme. Depends on whether you save the workspace 
```
